...
declare -A package
package[grpc/core]=core
package[grpc/testing]=testing

for proto in "${protos[@]}"; do
    opts[${#opts[@]}]="--go_opt=M${proto}=github.com/grpc/test-infra/proto/grpc/${package[${proto%/*}]}"
done

protoc -I../third_party/grpc-proto --go_out=. \
        --go_opt=paths=source_relative "${opts[@]}" "${protos[@]}"
