...
import (
	grpc_core "github.com/grpc/test-infra/proto/grpc_core"
...
type ServerStats struct {
	...
	// Core library stats
	CoreStats *grpc_core.Stats `protobuf:"bytes,7,opt,name=core_stats,json=coreStats,proto3" json:"core_stats,omitempty"`
}
...
func (x *ServerStats) GetCoreStats() *grpc_core.Stats {
	if x != nil {
		return x.CoreStats
	}
	return nil
...
func (x *ClientStats) GetCoreStats() *grpc_core.Stats {
	if x != nil {
		return x.CoreStats
	}
	return nil
...
var file_grpc_testing_stats_proto_goTypes = []interface{}{
	...
	(*grpc_core.Stats)(nil),    // 5: grpc.core.Stats
}
